...
const Home = () => {
  ...
  return (
    <div className='min-h-[80vh] w-full flex flex-col justify-center items-center gap-0.5 text-center'>

      <h1 className='text-3xl font-semibold'>NexaAI</h1>
      <p className='text-2xl font-semibold'>Next-Generation AI Chatbot</p>

      <p className='text-xl font-semibold mt-6 px-2'>Ask questions, generate ideas, and get instant help anytime.<br/>
      Log in to explore everything this chatbot has to offer. </p>
